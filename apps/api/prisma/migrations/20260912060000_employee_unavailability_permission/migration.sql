...
VALUES ('permission-employees-unavailability', 'employees.unavailability', 'Gerenciar indisponibilidades', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
FROM "Permission"
WHERE "key" = 'employees.unavailability'
