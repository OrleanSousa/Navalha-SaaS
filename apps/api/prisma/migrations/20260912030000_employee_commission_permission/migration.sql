...
VALUES ('permission-employees-commission', 'employees.commission', 'Configurar comissão padrão', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
FROM "Permission"
WHERE "key" = 'employees.commission'
